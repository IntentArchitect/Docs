...
A Stereotype defined in a Module are useable in the following ways:

- The Module author can refer to an easy to use Api for querying Stereotypes (which is generated by Intent Architect).
- The users of the Module in Intent Architect, who can apply Stereotypes to elements.
