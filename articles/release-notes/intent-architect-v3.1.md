...
- When creating an application or solution, there is now an option to create/update `.gitignore` files to ignore [relevant files](xref:application-development.applications-and-solutions.git-and-scm-guidance).
