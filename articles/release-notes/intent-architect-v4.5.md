...
- Feature: Easily let us know of any documentation topic you were looking for on our Help screen:

  ![The "Help" dialog](images/help-dialogue.png)

  ![Request topic form](images/request-topic-form.png)

- Feature: Open Visual Studio solutions in your IDE. The Software Factory and application context menus in the Solution Explorer will now show an "Open in IDE" option if at least one `.sln` has been generated by the Software Factory:

  ![Open in IDE feature on the Software Factory screen](images/open-in-ide-on-software-factory.png)
