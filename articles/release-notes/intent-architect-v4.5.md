...
- Improvement: Various improvements to the Help dialogue.
  ...
  As a reminder, the Help Dialog is accessible either by using the F1 shortcut or by pressing the question question mark icon at the top right corner of the UI:
...
- Improvement: Open Visual Studio solutions in your IDE. The Software Factory and application context menus in the Solution Explorer will now show an "Open in IDE" option if at least one `.sln` has been generated by the Software Factory:
