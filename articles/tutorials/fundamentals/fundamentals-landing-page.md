...
<div class="docs-tiles-grid">
  <div class="feature-card">
    <a href="xref:tutorials.fundamentals-1-building-an-application">
  ...
  <div class="feature-card">
    <a href="xref:tutorials.fundamentals-2-intro-to-domain-modeling">
      <svg class="landing-svg" viewBox="0 0 24 24">
  ...
  <div class="feature-card">
    <a href="xref:tutorials.fundamentals-3-create-crud-service">
      <svg class="landing-svg" viewBox="0 0 24 24">
...
<div class="docs-tiles-grid">
  <div class="feature-card">
    <a href="xref:tutorials.fundamentals-4-create-non-crud-service">
      <svg class="landing-svg" viewBox="0 0 24 24">
  ...
  <div class="feature-card">
    <a href="xref:tutorials.fundamentals-5-customizing-code">
      <svg class="landing-svg" viewBox="0 0 24 24">
          <path d="M9 12h6" />
          <path d="M12 9v6" />
  ...
  <div class="feature-card">
    <a href="xref:tutorials.fundamentals-6-version-control">
      <svg class="landing-svg" viewBox="0 0 24 24">
