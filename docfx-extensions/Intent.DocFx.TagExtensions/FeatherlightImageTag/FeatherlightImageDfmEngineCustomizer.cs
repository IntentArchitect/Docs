...
namespace Intent.DocFx.TagExtensions.FeatherlightImageTag
{
    ...
    public class FeatherlightImageDfmEngineCustomizer : IDfmEngineCustomizer
    {
        public void Customize(DfmEngineBuilder builder, IReadOnlyDictionary<string, object> parameters)
        {
            ...
            builder.InlineRules = builder.InlineRules.Insert(0, new FeatherlightImageInlineRule());
        }
    }
}
