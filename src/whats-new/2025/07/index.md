...
We are proud to announce 4.5 is officially live, for full details available in the [release notes](https://docs.intentarchitect.com/release-notes/intent-architect-v4.5.html) .
...
To learn more about the Identity Service module, read the [documentation here](https://docs.intentarchitect.com/modules-dotnet/intent-aspnetcore-identityservice/intent-aspnetcore-identityservice.html).
...
To learn more about the Identity module, read the [documentation here](https://docs.intentarchitect.com/modules-dotnet/intent-aspnetcore-identity/intent-aspnetcore-identity.html)
...
To learn more about the Azure Service Bus module, read the [documentation here](https://docs.intentarchitect.com/modules-dotnet/intent-eventing-azureservicebus/intent-eventing-azureservicebus.html).
