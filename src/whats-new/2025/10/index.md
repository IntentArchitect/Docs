...
![Overview of REST Integration](images/external-api-overview.png)
...
For more information, see the [documentation](https://docs.intentarchitect.com/modules-dotnet/intent-aws-lambda-functions/intent-aws-lambda-functions.html).
...
Refer to the [Scalar module documentation](https://docs.intentarchitect.com/modules-dotnet/intent-aspnetcore-scalar/intent-aspnetcore-scalar.html) for more information.
