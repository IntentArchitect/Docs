...
Check out the [release notes here](https://docs.intentarchitect.com/release-notes/intent-architect-v4.5.html) - this version is fully backwards compatible.
...
AI-powered functionality is currently available in the [Intent.AI.AutoImplementation](#handler-auto-implementation) and [Intent.AI.UnitTests](#unit-test-generation) modules:
...
As with [other AI-powered modules](#handler-auto-implementation), generated output can further be refined, by providing additional guidance through an optional prompt, enabling more accurate and tailored code generation.
...
To learn more, read the [module documentation](https://docs.intentarchitect.com/modules-dotnet/intent-aspnetcore-odata-entityframework/intent-aspnetcore-odata-entityframework.html).
...
To learn more, read the [module documentation](https://docs.intentarchitect.com/modules-dotnet/intent-entityframeworkcore-diffaudit/intent-entityframeworkcore-diffaudit.html).
...
To learn more, read the [module documentation](https://docs.intentarchitect.com/modules-dotnet/intent-application-automapper/intent-application-automapper.html#profile-location).
...
To learn more, read the [module documentation](https://docs.intentarchitect.com/modules-dotnet/intent-entityframeworkcore-repositories/intent-entityframeworkcore-repositories.html).
...
To learn more, read the [module documentation](https://docs.intentarchitect.com/modules-dotnet/intent-visualstudio-projects/intent-visualstudio-projects.html#the-visual-studio-solution-options-stereotype).
...
To learn more, read the [module documentation](https://docs.intentarchitect.com/modules-dotnet/intent-entityframework-application-linqextensions/intent-entityframework-application-linqextensions.html).
...
To learn more, read the [module documentation](https://docs.intentarchitect.com/modules-dotnet/intent-iac-terraform/intent-iac-terraform.html).
