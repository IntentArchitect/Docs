...
- Highlights
  ...
  - **[Azure Function Cosmos DB Triggers](#azure-function-cosmos-db-triggers)** - You can now model Cosmos DB triggers in the Service Designer.
...
Available on our website [here](https://docs.intentarchitect.com/application-development/development-environment/intent-in-the-development-environment.html).
