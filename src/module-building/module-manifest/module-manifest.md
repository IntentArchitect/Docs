...
| dependencies             | The module dependencies and their minimum versions. The Module Builder will ignore any added dependencies or version updates that are higher than what the Module Builder is applying. See [Dependency Installation Attributes](#dependency-installation-attributes) for optional dependency installation behavior. |
...
These values align with the Installation Settings options described in [About Modules](xref:application-development.applications-and-solutions.about-modules).
