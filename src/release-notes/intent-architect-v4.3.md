...
### Issues fixed in 4.3.9

- Fixed: Binary files generated by Static Content templates could cause Software Factory exceptions to occur.
- Fixed: Under certain circumstances modules would be incorrectly installed with the "metadata only" option.
